...
class ShadowLevelTest : public ILevel
{
public:
	ShadowLevelTest(Camera *i_camera)		 
		: mainSpotLight_(Vector3(0.0f, 40.0f, 10.0f), 90.0f, -180.0f, 100.0f), mainCamera_(i_camera)
	{
	}
...
private:
	...
	GLuint depthProgram_, teapotProgram_, planeProgram_, lightProgram_;
	GLuint VAOTeapot_, VAOPlane_, VAOLight_, VAOPlaneTest_;
